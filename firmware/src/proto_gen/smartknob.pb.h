...
typedef struct _PB_SmartKnobConfig {
 ...
 with more configurability in a future protocol version. */
    int16_t led_hue;
    /* *
 Value that when changed indicates that the pin task should be executed. */
    uint8_t pin_nonce;
} PB_SmartKnobConfig;
...
#define PB_SmartKnobConfig_pin_nonce_tag         14
...
X(a, STATIC,   SINGULAR, UINT32,   pin_nonce,        14)
...
#define PB_SmartKnobConfig_size                  187
#define PB_SmartKnobState_size                   209
#define PB_StrainCalibration_size                22
#define PB_ToSmartknob_size                      199
